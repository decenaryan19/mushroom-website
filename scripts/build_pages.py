...
HEAD = """  <meta charset="UTF-8">
  ...
  <style>
    body{{margin:0;font-family:system-ui,-apple-system,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;background:#fffdee;color:#1f2937}}
    .site-header{{position:sticky;top:0;z-index:50;background:#fff;box-shadow:0 1px 2px rgba(0,0,0,.06)}}
  </style>
  ...
  <header class="site-header">
    <div class="container site-header__inner">
      <a href="../index.html" class="site-logo" aria-label="Suwannee Bell Farms — Home">
        <img src="../images/logo.webp" alt="Suwannee Bell Farms logo" width="44" height="44" decoding="async">
      </a>
